...
def obj_onedot(x, params, ampmaskfunc, phasemaskfunc, optimize):
...
#    pulse.gen_rabifreq(params['qdot_params'].qdot_d_yo,delta)
    ...
    pulse.detuning(params['qdot_params'].qdot_omega_yo)
    pulse.plotefield()
    ...
    if optimize:
        ...
        t = numpy.linspace(t_start, t_end, NSTEPS, endpoint=True)
