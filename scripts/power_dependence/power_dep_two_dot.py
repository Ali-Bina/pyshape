...
# save data to ifile
savetxt('scripts/power_dependence/script_results.txt', transpose((pulse_area, fidelity1, fidelity2, overallFid)), header='Pulse Area (PI rad), Fidelity DOT 1, Fidelity DOT 2, Overall Fidelity')

# load data and plot
pulse_area, fidelity1, fidelity2, overall_fid = loadtxt("scripts/power_dependence/script_results.txt", delimiter = " ", unpack=True, skiprows=1)
