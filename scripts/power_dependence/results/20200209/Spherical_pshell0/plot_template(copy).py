...
#plt.show()
#
plt.plot(var2,var3,label="sphere_p",marker='o',markerfacecolor='None',linewidth=3.0,markeredgecolor='g',color='g',markeredgewidth=1,markersize=10) #add 3rd variable 
