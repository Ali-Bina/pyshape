...
import glob
from plot_contour_N import occupation_N
import os

os.chdir("/home/ajan/Documents/pyshape_edited/scripts/power_dependence/results/20180601/more_resolved/P6140")
...
diff= (occupation-occupation_N)#/np.amax(occupation-occupation_N)

plt.figure()
A,B=np.meshgrid(wl,pulse_area)
plt.contourf(A, B,diff,300)
#plt.clim(0,1)
