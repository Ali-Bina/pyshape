...
Title="M25_S4 "
filename= 'occupation_300000.0fs2_1163.002nm_0.001491.txt' 
location2='/home/ajan/Documents/pyshape_edited/scripts/power_dependence/results/20191110/N300/'
filename2='occupation_-300000.0fs2_1163.002nm_0.001491.txt' 
...
var2=np.loadtxt(location2+filename2,skiprows = 0) #2nd variable -yaxis1 check usecol,delimiter
...
#plt.show()
#plt.figure()
plt.plot(var[:,0],0.5*(var[:,3]+1),label='Spherical dot'+r'$\phi^{\prime \prime} >0$',linewidth=2.5,linestyle='--',color='y') #add 3rd variable
plt.plot(var[:,0],0.5*(var2[:,3]+1),label='Spherical dot'+r'$\phi^{\prime \prime} <0$',linewidth=2.5,linestyle='--',color='b')
