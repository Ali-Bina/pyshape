...
data_folder = 'scripts/two_dot_energy_energy/'										#***********
...
# set up axes
var1_init = energy_dot_1_init														#***********
var1_delta = 0.01																		#***********
NITER_var1 = 2		# make sure NITER is odd to get the value at 0		#***********
var2_init = energy_dot_2_init														#***********
var2_delta = 0.01																		#***********
NITER_var2 = 2		# make sure NITER is odd to get the value at 0		#***********
...
savetxt(data_folder + 'script_results_axes_energy_dot_1.txt', transpose(var1), header='Energy 1 dipole (eV)')	#***********
savetxt(data_folder + 'script_results_axes_energy_dot_2.txt', transpose(var2), header='Energy 2 dipole (eV)')	#***********
...
for i in range(i_initial, i_final):
	config['qdot']['omega_yo'] = var1[i]				#***********
	for j in range(j_initial, j_final):
		print "i,j = {0}, {1}".format(i, j)
		config['qdot2']['omega_yo'] = var2[j]		#***********
		config.write()
...
xlabel(r'Energy Dot 1 (eV)')	#***********
ylabel(r'Energy Dot 2 (eV)')	#***********
show()
